...
import { createEventDraft, makeId } from "@/lib/utils";
import type { Event, EventDraft } from "@/lib/types";
import { Button } from "@/components/ui/button";

export const dynamic = "force-dynamic"; // in case we later fetch

export default function EventsPage() {
  const [events, setEvents] = React.useState<Event[]>(() => seedEvents());
